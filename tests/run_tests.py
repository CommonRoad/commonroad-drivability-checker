...
if __name__ == "__main__":
    ...
    for x in os.walk(os.getcwd()):
        ...
        # TODO test_vehicle_dynamics has a scipy.odeint bug and is temporarily disabled in CI
        if not '__' in x[0] and not '.' in x[0] and not 'costs' in x[0] and not 'test_vehicle_dynamics' in x[0]:
            print(x[0])
