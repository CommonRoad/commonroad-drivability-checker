...
#undef IFNOLEXER
		   ...
		   types.
			...
			std::unique_ptr<FlexLexer> lexer( ::s11n::cl::classload<FlexLexer>( lexerClassName ) );
				...
				os << "s11n::io::deserialize_lex_forwarder(): Lexer '"<<lexerClassName
				   <<"' was not found by classload<FlexLexer>()."
				   << " It is probably not registered with the classloader."
					;
				throw ::s11n::s11n_exception( os.str(), __FILE__, __LINE__ );
                        }
