...
solution_file_path = Path(__file__).parent.parent.joinpath( 
    ...
    #'solutions/KS2:SM1:BEL_Putte-11_1_T-1:2020a/3e00d681-f990-4947-93ac-143bea9388af.xml' 
    
    # # Flensburg
    #'solutions/KS2:SM1:DEU_Flensburg-31_1_T-1:2020a/0c308d9c-c809-4f21-9be2-367bb7b42919.xml' 
    ...
    #'solutions/KS2:SM1:DEU_Meckenheim-2_3_T-1:2020a/3b521e2d-62b2-4c61-a081-5bd153ec5834.xml' 
    #'solutions/KS2:SM1:DEU_Meckenheim-2_3_T-1:2020a/3cfcbcd4-8425-4076-993f-4c926919886a.xml'
    
    ## Carcarana
    #'solutions/KS2:SA1:ARG_Carcarana-11_1_T-1:2020a/4f12ef7b-f723-467b-9893-4de2ea972b30.xml' # takes too much time
