...
void init_module_geometry(py::module &m) {
  ...
  py::class_<geometry::Segment>(m, "Segment")
      ...
      .def("pt_1", &geometry::Segment::pt_1, ":return: start point of segment in Cartesian coordinates")
      .def("pt_2", &geometry::Segment::pt_2, ":return: end point of segment in Cartesian coordinates")
      .def("length", &geometry::Segment::length, ":return: segment length")
      .def("normal_segment_start", &geometry::Segment::normalSegmentStart, ":return: normal vector at the start of the segment")
      .def("normal_segment_end", &geometry::Segment::normalSegmentEnd, ":return: normal vector at the end of the segment");
  ...
  py::class_ < geometry::CurvilinearCoordinateSystem,
      std::shared_ptr < geometry::CurvilinearCoordinateSystem > > (m, "CurvilinearCoordinateSystem")
          ...
          .def(py::init<const geometry::EigenPolyline &, const double, const double, const double>(),
    ...
    projection domain border from the reference path.\n:param reference_path: 2D polyline in Cartesian coordinates\n:param default_projection_domain_limit: maximum absolute distance of the projection domain border from the reference path, defaults to 20\n:param eps: reduces the lateral distance of the projection domain border from the reference path, defaults to 0.1\n:param eps2: if nonzero, adds additional segments to the beginning (3 segments) and the end (2 segments) of the reference path to enable the conversion of the points near the beginning and the end of the reference path, defaults to 0, the recommended value is 0.000001"
          ...
          .def("reference_path", &geometry::CurvilinearCoordinateSystem::referencePath, "Returns the border of the unique projection domain of the curvilinear coordinate system in Cartesian coordinates\n\n:Returns: 2D polyline representing the border of the projection domain")
          .def("projection_domain", &geometry::CurvilinearCoordinateSystem::projectionDomainBorder,"Returns the border of the unique projection domain of the curvilinear coordinate system in Cartesian coordinates\n\n:Returns: 2D line string representing the border of the projection domain")
          .def("curvilinear_projection_domain",
               &geometry::CurvilinearCoordinateSystem::curvilinearProjectionDomainBorder,"Returns the border of the unique projection domain of the curvilinear coordinate system in curvilinear coordinates\n\n:Returns: 2D line string representing the border of the projection domain")
          .def("segments_longitudinal_coordinates", &geometry::CurvilinearCoordinateSystem::segmentsLongitudinalCoordinates,":return: array containing longitudinal coordinates corresponding to the start point of each segment")
          .def("set_curvature", &geometry::CurvilinearCoordinateSystem::setCurvature,"Currently, the curvature of the reference path is not computed automatically and must be set.\
          ...
          .def("curvature_range", &geometry::CurvilinearCoordinateSystem::curvatureRange,"Returns an interval of the curvatures of the reference path within a given range of longitudinal positions\n\n:param s_min: minimum longitudinal position\n:param s_max: maximum longitudinal position\n\n:return: enclosing interval of curvature values of the reference path within the range [s_min, s_max]")
          .def("maximum_curvature_radius", &geometry::CurvilinearCoordinateSystem::maximumCurvatureRadius, "Returns the maximum curvature radius along the reference path of the curvilinear coordinate system\n\n:Returns: maximum curvature radius")

		  .def("minimum_curvature_radius", &geometry::CurvilinearCoordinateSystem::minimumCurvatureRadius, "Returns the minimum curvature radius along the reference path of the curvilinear coordinate system\n\n:Returns: minimum curvature radius")
          .def("maximum_curvature", &geometry::CurvilinearCoordinateSystem::maximumCurvature,"Returns the maximum curvature along the reference path of the curvilinear coordinate system.\n\n:Returns: maximum curvature")
          .def("minimum_curvature", &geometry::CurvilinearCoordinateSystem::minimumCurvature,"Returns the minimum curvature along the reference path of the curvilinear coordinate system.\n\n:Returns: minimum curvature")
		  .def("normal", &geometry::CurvilinearCoordinateSystem::normal,"Normal vector at a specific longitudinal coordinate.\n\n:param s: longitudinal coordinate.\n\n:Returns: normal vector")
		  .def("tangent", &geometry::CurvilinearCoordinateSystem::tangent,"Tangent vector at a specific longitudinal coordinate.\n\n:param s: longitudinal coordinate\n\n:Returns: tangent vector")
          .def("convert_to_cartesian_coords", &geometry::CurvilinearCoordinateSystem::convertToCartesianCoords,"Transforms a point in the curvilinear coordinate frame to the global coordinate frame.\n\n:param s: longitudinal coordinate\n\n:param l: lateral coordinate\n\n:Returns: point in global coordinates")
          .def("cartesian_point_inside_projection_domain",
               &geometry::CurvilinearCoordinateSystem::cartesianPointInProjectionDomain,"Validates if a point in global coordinates is within the unique projection domain of the curvilinear coordinate system.\n\n:param x: x-coordinate in the Cartesian coordinate system\n\n:param y: y-coordinate in the Cartesian coordinate system\n\n:Returns: True if the point is inside or on the boundary of the projection domain, False if the point is outside of the boundary of the projection domain.")
          .def("determine_subset_of_polygon_within_projection_domain",
               &geometry::CurvilinearCoordinateSystem::determineSubsetOfPolygonWithinProjectionDomain,"Computes the parts of a polygon which are inside the unique projection domain of the curvilinear coordinate system.\n\n:param polygon: vertices of the boundary of the polygon; vertices must be sorted clockwise and given as closed list (the last vertex must be the same as the first one)\n\n:Returns: parts of the polygon which are inside the projection domain.")
          .def("determine_subsets_of_multi_polygons_within_projection_domain", [](
            ...
            return return_val;
          },"Intersects each of the input polygons with the projection domain and returns the result of the intersection.\n\n:param polygons: input list of polygons\n\n:param groups_of_polygons: list of integers (of the same length as the list of input polygons) indicating the integer ID of the polygon group for each input polygon. It is useful because the list of output polygons after the intersection may be shorter and we return the polygon group IDs for each of the output polygons.\n\n:param num_omp_threads: number of OMP threads for parallel computation\n\n:return: (list of polygons produced after the intersection, list containing group ID for each of the output polygons).")
          ...
          .def("convert_list_of_polygons_to_curvilinear_coords_and_rasterize", [](
            ...
            return return_val;
          },"Transforms polygons in the Cartesian coordinates to the curvilinear coordinates.\n\n:param polygons: list of input polygons\n\n:param groups_of_polygons: group ID (from 0 to num_polygon_groups-1) for each input polygon, list of integers\n\n:param num_polygon_groups: number of polygon groups\n\n:param num_omp_threads: number of OMP threads for parallel computation\n\n:return: (list of lists of output polygons, list of lists of rasterized output polygons). Both outermost lists contain lists of output polygons - for each polygon group")
