...
set(crcc_install_cmakedir ${CMAKE_INSTALL_LIBDIR}/cmake/${PROJECT_NAME})
set(crcc_config_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}Config.cmake)
set(crcc_version_file ${CMAKE_CURRENT_BINARY_DIR}/${PROJECT_NAME}ConfigVersion.cmake)

configure_package_config_file(
        ${PROJECT_SOURCE_DIR}/cmake/${PROJECT_NAME}Config.cmake.in
        ${crcc_config_file}
        INSTALL_DESTINATION ${crcc_install_cmakedir}
)
...
install(FILES ${crcc_config_file}
        ${crcc_version_file}
        DESTINATION ${crcc_install_cmakedir}
)
...
if (CR_DC_USE_TRIANGLE)
    list(APPEND foreign_targets_base triangle)
endif ()
