...
class CurvilinearCoordinateSystem {
 public:
   ...
   *
   * @return reference path to which the curvilinear coordinate system is aligned to
   */
  ...
  /**
   * Returns the length of the reference path of the curvilinear coordinate system
   *
   * @return length
   */
  double length() const;
